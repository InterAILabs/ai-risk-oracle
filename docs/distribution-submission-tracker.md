...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| GitHub release/topics/search | https://github.com/InterAILabs/ai-risk-oracle | Source repository | P0 | `submitted` | Yes | GitHub maintainer | Repo metadata and release hygiene | Manual metadata update | README, CHANGELOG, release, `distribution/submission-assets.md` | Confirm repo description, homepage, and topics from the exact topic list below. | 2026-06-16 | Releases `v0.1.0-beta` and `v0.1.1-beta` exist as pre-releases. Old PR #1 was closed and superseded branch was deleted. Do not claim directory presence from GitHub metadata alone. |
...
| MCP Registry | https://registry.modelcontextprotocol.io | MCP ecosystem | P0 | `published_verified` | Yes | GitHub namespace authenticated | Remote `server.json` publish flow | Manual first publish completed | `server.json`, `distribution/mcp-readiness.md` | Monitor the exact API record and keep later versions aligned with public releases. | 2026-08-25 | `io.github.InterAILabs/ai-risk-oracle@0.1.2-beta` is published and returned by the official Registry API; official client v2.0.0 completed handshake, tools/list, and tool call. |
