...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| GitHub release/topics/search | https://github.com/InterAILabs/ai-risk-oracle | Source repository | P0 | `blocked_needs_auth` | Yes | GitHub maintainer | Repo metadata and release hygiene | Manual metadata update | README, CHANGELOG, release, `distribution/submission-assets.md` | Create `v0.1.1-beta` pre-release manually after GitHub auth is repaired. | 2026-06-16 | Release `v0.1.0-beta` exists as a pre-release. Draft `v0.1.1-beta` notes exist. GitHub CLI auth was invalid during final readiness audit. Do not claim directory presence from GitHub metadata alone. |
