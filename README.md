...
- published TypeScript SDK on npm: `interai-risk-oracle@0.1.6-beta` (`beta` dist-tag)
- published Python SDK on PyPI: `interai-risk-oracle==0.1.6b0`
- MCP remote
- A2A endpoint
...
SDK package versioning is independent from the hosted runtime version. The hosted service and its discovery manifests remain on their current runtime release until a separate runtime release is made.
...
- PyPI: https://pypi.org/project/interai-risk-oracle/0.1.6b0/
